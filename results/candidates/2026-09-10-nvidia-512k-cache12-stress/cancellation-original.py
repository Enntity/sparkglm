...
try:
 ...
 with post({'model':'sparkglm-package','messages':[{'role':'user','content':'Write a very long numbered list of 2000 distinct everyday objects. Continue until all 2000 are listed.'}],'max_tokens':8192,'temperature':0,'stream':True}) as response:
