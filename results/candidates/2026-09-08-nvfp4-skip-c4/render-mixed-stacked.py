...
root=pathlib.Path(sys.argv[1]);sets=json.loads((root/'comparison.json').read_text());fps=12;W,H=1280,1400
...
for frame in range(math.ceil(end*fps)):
 ...
 d.text((30,20),'SparkGLM vs Mia · staggered C4',font=F[38],fill='#f3f6fb')
 ...
 d.text((30,1320),'Mia: as-shipped skip scheduling. SparkGLM: current NVFP4 recipe. Median of 3 runs each; configurations differ.',font=F[20],fill='#a8b9cb')
