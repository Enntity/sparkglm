...
for frame in range(math.ceil(end*fps)):
 ...
 d.text((30,20),'SparkGLM vs Mia · both skip · C4',font=F[38],fill='#f3f6fb')
 ...
 d.text((30,1320),'Both use skip. Median of 3 runs each; context, chunks, draft weights and kernels differ.',font=F[20],fill='#a8b9cb')
